    ...
    function hUUv(module, __webpack_exports__, __webpack_require__) {
      ...
      var OjtRegistrationComponent = /*#__PURE__*/function () {
        ...
        _createClass(OjtRegistrationComponent, [{
          ...
          key: "checkIsSuperAdmin",
          value: function checkIsSuperAdmin() {
            this.isSuperAdmin = this.userDet.roles.some(function (role) {
              return role.name === "SUPERADMIN";
            });
          }
        }, {
          key: "handleDeletePendingOJT",
          value: function handleDeletePendingOJT(obj) {
            var _this4 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
              ...
              if (result.isConfirmed) {
                _this4.apiService.deletePendingOJTPlan("deleteOjtRegistration", payload).subscribe(function (response) {
                  if (response.result) {
                    _this4.alertService.success("OJT Deleted successfully");

                    _this4.getOjtRegList("");
                  } else {
                    _this4.alertService.error("Error deleting OJT");
                  }
                });
              }
            });
        ...
        _createClass(OjtRegistrationDetailsComponent, [{
          ...
          value: function getOJTRegistrationDetails() {
            ...
            this.appService.getOJTRegistrationDetails('apis/sm/getOJTRegistrationDetails/' + this.selectedDetail.ojtRegisId).subscribe(function (response) {
              ...
              if (response.result) {
                if (response.data) {
                  _this5.ojtRegiDetails = response.data;
                  console.log(_this5.ojtRegiDetails);

                  if (_this5.ojtRegiDetails.skillingList != null && _this5.ojtRegiDetails.skillingList.length > 0) {
                    _this5.dayWiseAuditList = _this5.ojtRegiDetails.skillingList; // this.dayList = this.dayWiseAuditList.dayWiseAuditList;

                    console.log(_this5.dayWiseAuditList);
                  }
                } else {
                  _this5.ojtRegiDetails = [];
                }
              } else {
                _this5.ojtRegiDetails = [];
              }
