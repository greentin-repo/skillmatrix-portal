(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["assessment-assessment-module"], {
    ...
    /***/
    function CTX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function iil(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ./assessment-detail/assessment-detail.module */
          "KXr7")).then(function (m) {
            return m.AssessmentDetailModule;
          });
        }
      }];
      ...
      AssessmentRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function AWsS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_assessment_detail_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./assessment-detail.component.html */
      "Eo/v");
      /* harmony import */


      var _assessment_detail_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _assessment_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./../assessment.service */
      "p3TK");
      /* harmony import */
      ...
      var AssessmentDetailComponent = /*#__PURE__*/function () {
        function AssessmentDetailComponent(modalConfig, modalService, fb, assessmentService, router, alertService, titleService, Constant) {
          ...
          this.isReqAssTime = false; // Assessment Module
          // date: 07/09/2023
        ...
        _createClass(AssessmentDetailComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.assessmentForm = this.fb.group({
              ...
              time: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required, this.noNegativeValidator]),
              passingMark: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required, this.noNegativeValidator])
          ...
          */
          ...
          key: "getObjFromArray",
          value: function getObjFromArray(array, obj) {
            var rec;
          ...
          */
          ...
          value: function getValueFromArray(array, value) {
            var rec = [];
          ...
          */
          ...
          key: "saveAssessment",
          value: function saveAssessment(data) {
            var _this = this;

            this.submitLoader = true;

            if (data.controls['assessmentType'].invalid || data.controls['branchId'].invalid || data.controls['deptId'].invalid || data.controls['cellLineId'].invalid || data.controls['workstationId'].invalid || data.controls['title'].invalid || data.controls['time'].invalid || data.controls['passingMark'].invalid || !this.isSafetyAssessment && data.controls['skillLvlId'].invalid) {
            ...
            console.log(reqBody);
            this.assessmentService.addAssessmentDetails("apis/sm/addAssessment", reqBody).subscribe(function (data) {
              _this.submitLoader = false;

              if (data.result) {
                _this.alertService.success("Assessment details added successfully.");

                _this.assessmentDet.assessmentId = data.responseData.assessmentId;
                _this.isCheckSheetAvailable = true;

                _this.getAssessmentDetails();
              } else {
                if (data.statusCode == 100) {
                  _this.alertService.error(data.reason);
                } else {
                  _this.alertService.error("Error occurred while submitting data. Please try again..");
                }
              }
            }, function (error) {
          ...
          */
          ...
          key: "updateAssesment",
          value: function updateAssesment(data) {
            var _this2 = this;
            ...
            this.assessmentService.updateAssessmentDetails("apis/sm/updateAssessment", reqBody).subscribe(function (data) {
              _this2.submitLoader = false;

              if (data.result) {
                _this2.alertService.success("Assessment details updated successfully.");

                _this2.isCheckSheetAvailable = true;

                _this2.getAssessmentDetails();
              } else {
                if (data.statusCode == 100) {
                  _this2.alertService.error(data.reason);
                } else {
                  _this2.alertService.error("Error occurred while updating data. Please try again..");
                }
              }
            });
          }
          ...
          */
          ...
          key: "openAddQuestionModal",
          value: function openAddQuestionModal(modal) {
            var _this3 = this;

            this.addQuestion = false; // this.isAssessmentAvailable = true;

            this.questionsList = [];
            var rec;

            if (this.assessmentDetails.interventionsList != null && this.assessmentDetails.interventionsList.length > 0) {
              rec = this.assessmentDetails.interventionsList.filter(function (res) {
                return res.interId == _this3.selectedDet.interventionId;
              });
            }
          ...
          */
          ...
          key: "addRemoveOptions",
          value: function addRemoveOptions(oIndex, type) {
            if (this.assessmentDet.tempQues.optList != null && this.assessmentDet.tempQues.optList.length > 4) {
              if (type == "add") {
                return;
              }
            }
            ...
            if (type == "add") {
              if (this.assessmentDet.tempQues.optList[oIndex].option == undefined || this.assessmentDet.tempQues.optList[oIndex].option == "" || this.assessmentDet.tempQues.optList[oIndex].option == null) {
                this.alertService.error("Please enter option");
                return;
              }

              this.assessmentDet.tempQues.optList.push({
                optIndex: this.assessmentDet.tempQues.optList != null ? this.assessmentDet.tempQues.optList.length : 0,
                option: "",
                isRightAns: false
              });
            } else {
          ...
          */
          ...
          value: function getAssessmentDetails() {
            var _this4 = this;

            this.assessmentService.getAssessmentDetailsById("apis/sm/getAssessmentDetail/" + this.assessmentDet.assessmentId).subscribe(function (data) {
              if (data.result) {
                _this4.selectedDet = Object.assign({}, _this4.selectedDet, data.assessment);
                _this4.editAssessment = true;
                _this4.isCheckSheetAvailable = true;
                ...
                if (tmpLocalData.assessmentId == 0) {
                  var newData = Object.assign({}, tmpLocalData, _this4.selectedDet);
                  _this4.selectedDet = newData;
                ...
                if (data.assessment.quesList != null && data.assessment.quesList.length > 0) {
                  var _loop = function _loop(index) {
                    if (data.assessment.quesList[index].optList != null && data.assessment.quesList[index].optList.length > 0) {
                      for (var opt = 0; opt < data.assessment.quesList[index].optList.length; opt++) {
                        data.assessment.quesList[index].optList[opt].option = data.assessment.quesList[index].optList[opt].option;
                      }

                      data.assessment.quesList[index].optList.forEach(function (currentValue, optIndex) {
                        if (currentValue.rightAns) {
                          data.assessment.quesList[index].rightAns = optIndex.toString();
                        }
                      });
                    }
                  };

                  for (var index = 0; index < data.assessment.quesList.length; index++) {
                    _loop(index);
                  }
                }

                _this4.assessmentDet.quesList = data.assessment.quesList;
                _this4.assessmentDetail = data.assessment;
                console.log(_this4.assessmentDetail);

                _this4.setSubCategoryGroup();
              } else {
                _this4.assessmentDet.quesListGroupBy = [];
              }
            });
          }
        }, {
          ...
          value: function setSubCategoryGroup() {
            ...
            var tmpCatIds = [];
            var quesArray = [];
            this.assessmentDet.quesList.filter(function (data) {
              if (tmpCatIds.indexOf(data.categoryId) == -1) {
                ...
                var _loop2 = function _loop2(x) {
                  if (tmpCatArray[x].catId == data.categoryId) {
                    if (data.subCategoryId > 0) {
                      if (tmpCatArray[x].subCatList != null && tmpCatArray[x].subCatList.filter(function (res) {
                        return res.subCatId == data.subCategoryId;
                      }).length > 0) {
                        tmpCatArray[x].subCatList.forEach(function (subCat, i) {
                ...
                for (var x = 0; x < tmpCatArray.length; x++) {
                  _loop2(x);
                }
              }
            });
          ...
          value: function ontemplateSelect(val) {
          ...
          */
          ...
          key: "saveQuestionandAns",
          value: function saveQuestionandAns(data) {
            var _this5 = this;
            ...
            if (this.assessmentDet.tempQues.optList == null || this.assessmentDet.tempQues.optList.length == 0) {
              this.alertService.error("Please add options.");
              this.submitLoader = false;
              return;
            }

            if (this.assessmentDet.tempQues.optList != null && this.assessmentDet.tempQues.optList.length < 2) {
              this.alertService.error("Please add minimum two options.");
              this.submitLoader = false;
              return;
            }

            if (this.assessmentDet.tempQues.optList.filter(function (rec) {
              return rec.isRightAns;
            }).length == 0) {
            ...
            this.assessmentDet.tempQues.optList.filter(function (element) {
              console.log(element);
            ...
            this.assessmentService.addQuestions("apis/sm/addAssessmentQuestion", reqbody).subscribe(function (data) {
              _this5.submitLoader = false;

              if (data.result) {
                _this5.alertService.success("Question added successfully.");

                _this5.getAssessmentDetails();
                ...
                if (data.statusCode == 100) {
                  ...
                  _this5.alertService.error("Error occurred while submitting data. Please try again.");
                }
              }
            });
          }
          ...
          key: "updateques",
          value: function updateques(modal, ques) {
            var _this6 = this;
            ...
            this.assessmentDet.tempQues = {
              ...
              selectedCat: [{
                id: ques.categoryId,
                name: ques.categoryName
              }],
              assessmentQuestion: ques.question,
              mark: ques.questionMark,
              optList: ques.optList
            };
            ques.optList.forEach(function (currentValue, optIndex) {
              console.log(currentValue);

              if (currentValue.rightAns) {
                _this6.assessmentDet.tempQues.isRightAns = optIndex.toString();
                console.log(_this6.assessmentDet.tempQues.isRightAns);
              }
            });
          ...
          key: "updateQuestionansAns",
          value: function updateQuestionansAns(data) {
            var _this7 = this;
            ...
            console.log(this.assessmentDet.tempQues.optList); // if (this.assessmentDet.tempQues.optList.filter(rec => rec.isRightAns).length == 0) {
            ...
            if (!this.assessmentDet.tempQues.isRightAns) {
              ...
              for (var opt = 0; opt < this.assessmentDet.tempQues.optList.length; opt++) {
            ...
            this.assessmentService.updateQuestionsAndOpt("apis/sm/updateAssessmentQuestion", reqBody).subscribe(function (data) {
              _this7.submitLoader = false;

              if (data.result) {
                _this7.alertService.success("Question updated successfully.");

                _this7.getAssessmentDetails();

                _this7.modalService.dismissAll();
              } else {
                if (data.statusCode == 100) {
                  _this7.alertService.error(data.reason);
                } else {
          ...
          key: "removeExistOption",
          value: function removeExistOption(opt, quesId) {
            var _this8 = this;
            ...
            this.assessmentService.deleteAssessmentOption("apis/sm/deleteAssessmentOptions", req).subscribe(function (res) {
              _this8.dataSpinner[quesId] = false;

              if (res.result) {
                _this8.alertService.success("Option removed successfully.");

                for (var index = 0; index < _this8.assessmentDet.tempQues.optList.length; index++) {
                  if (_this8.assessmentDet.tempQues.optList[index].assessmentQueOptId == opt.assessmentQueOptId) {
                    _this8.assessmentDet.tempQues.optList.splice(index, 1);
                ...
                if (res.statusCode == 100) {
                  _this8.alertService.error(res.reason);
                } else {
                  _this8.alertService.success("Error occurred while removing option. Please try again.");
                }
              }
            });
          }
        }, {
          key: "showDeleteQuestModal",
          value: function showDeleteQuestModal(ques) {
            var _this9 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
              ...
              _this9.dataSpinner[ques.quetionId] = true;

              if (result.isConfirmed) {
                var reqbody = {
                  assessmentId: _this9.assessmentDet.assessmentId,
                  assessmentQueId: ques.quetionId,
                  updatedBy: _this9.loggedInEmpDet.empId,
                  createdBy: _this9.loggedInEmpDet.empId
                };

                _this9.assessmentService.deleteAsssessmentQuesAndOption("apis/sm/deleteAssessmentQuestion", reqbody).subscribe(function (data) {
                  _this9.dataSpinner[ques.quetionId] = false;

                  if (data.result) {
                    _this9.alertService.success("Question removed successfully.");

                    _this9.getAssessmentDetails();
                  } else {
                    if (data.statusCode == 100) {
                      _this9.alertService.error(data.reason);
                    } else {
                      _this9.alertService.error("Error occurred while removing data. Please try again");
                    }
                  }
                });
              } else {
          ...
          key: "publishAssessment",
          value: function publishAssessment() {
            var _this10 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
              ...
              if (result.isConfirmed) {
                var reqbody = {
                  assessmentId: _this10.assessmentDet.assessmentId,
                  updatedBy: _this10.loggedInEmpDet.empId,
                  createdBy: _this10.loggedInEmpDet.empId
                };

                _this10.assessmentService.publishAsssessment("apis/sm/publishAssessments", reqbody).subscribe(function (data) {
                  _this10.deletePublishloader = false;

                  if (data.result) {
                    _this10.alertService.success("Assessment published successfully.");

                    _this10.router.navigateByUrl("settings/skillMatrix/assessment");
                  } else {
                    if (data.statusCode == 100) {
                      _this10.alertService.error(data.reason);
                    } else {
                      _this10.alertService.error("Error occurred while publishing assessment. Please try again");
                    }
                  }
                });
              } else {
          ...
          value: function deleteAssessment() {
            var _this11 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
              ...
              if (result.isConfirmed) {
                var reqbody = {
                  assessmentId: _this11.assessmentDet.assessmentId,
                  updatedBy: _this11.loggedInEmpDet.empId,
                  createdBy: _this11.loggedInEmpDet.empId
                };

                _this11.assessmentService.deleteAsssessment("apis/sm/deActiveAssessment", reqbody).subscribe(function (data) {
                  _this11.deletePublishloader = false;

                  if (data.result) {
                    _this11.alertService.success("Record removed successfully.");

                    _this11.router.navigateByUrl("/settings/skillMatrix/assessment");
                  } else {
                    if (data.statusCode == 100) {
                      _this11.alertService.error(data.reason);
                    } else {
                      _this11.alertService.error("Error occurred while deleting data. Please try again");
                    }
                  }
                });
              } else {
          ...
          key: "isCatgeorycheck",
          value: function isCatgeorycheck() {
            this.assessmentDet.isCatgeorychecked = !this.assessmentDet.isCatgeorychecked;
          }
          /*
          ...
          key: "addCategory",
          value: function addCategory(modal) {
            this.catUpdateFlag = false;
          ...
          */
          ...
          key: "submitCatAndSubCat",
          value: function submitCatAndSubCat(c) {
          ...
          key: "addCatAndSubCategory",
          value: function addCatAndSubCategory(c) {
            var _this12 = this;
            ...
            console.log(reqBody);
            this.assessmentService.addCatgeoryand("apis/sm/addCategory", reqBody).subscribe(function (data) {
              _this12.submitCatLoader = false;

              if (data.result) {
                _this12.alertService.success("Category details added successfully.");

                c("Cross Click");

                _this12.getcategroryDetails();
              } else {
                if (data.statusCode == 100) {
                  _this12.alertService.error(data.reason);
                } else {
                  _this12.alertService.error("Error occurred while deleting data. Please try again");
                }
              }
            });
          }
          ...
          */
          ...
          key: "updateCatAndSubCategory",
          value: function updateCatAndSubCategory(c) {
            var _this13 = this;
            ...
            this.assessmentService.updateCatgeory("apis/sm/updateCategory", reqBody).subscribe(function (data) {
              _this13.submitCatLoader = false;

              if (data.result) {
                _this13.alertService.success("Category details updated successfully.");

                c("Cross Click");

                _this13.getcategroryDetails();
              } else {
                if (data.statusCode == 100) {
                  _this13.alertService.error(data.reason);
                } else {
                  _this13.alertService.error("Error occurred while deleting data. Please try again");
                }
              }
            });
          }
          ...
          */
          ...
          key: "getcategroryDetails",
          value: function getcategroryDetails() {
            var _this14 = this;

            var req = {
              assessmentId: this.assessmentDet.assessmentId
            };
            this.assessmentService.getCatgeoryList("apis/sm/getCategoryList", req).subscribe(function (data) {
              if (data.result) {
                if (data.dataList != null && data.dataList.length > 0) {
                  _this14.assessmentDet.isCatgeorychecked = true;
                  _this14.assessmentDetails.categoryList = data.dataList;
                  _this14.categoryList = _this14.setArray(_this14.assessmentDetails.categoryList, "id", "categoryName"); // this.assessmentDetails.categoryList.forEach(cat => {
                  //   this.categoryListIds.push(cat.id)
                  // });
                  // this.getSubcategroryDetails(this.categoryListIds);
                } else {
                  _this14.assessmentDetails.categoryList = []; // this.catAndSubCatList = [];
                }
              } else {
                _this14.assessmentDetails.categoryList = []; // this.catAndSubCatList = [];
              }
          ...
          */
          ...
          key: "viewCategory",
          value: function viewCategory(modal) {
            var _this15 = this;
          ...
          */
          ...
          key: "editCatAndSubCat",
          value: function editCatAndSubCat(content, list) {
            this.catUpdateFlag = true;
            this.assessmentDet.category = list.categoryName;
            this.assessmentDet.categoryId = list.id;
            this.assessmentDet.assessmentId = list.assessmentId; // if (list.subCategoryList != null && list.subCategoryList.length > 0) {
          ...
          */
          ...
          key: "deleteCatAndSubCat",
          value: function deleteCatAndSubCat(catId) {
            var _this16 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
              ...
              if (result.isConfirmed) {
                ...
                _this16.assessmentService.deleteCatgeory("apis/sm/deleteCategory", req).subscribe(function (data) {
                  if (data.result) {
                    // if (data.reason != '' || data.reason != undefined) {
                    //   this.alertService.success(data.reason)
                    // } else {
                    _this16.alertService.success("Category deleted successfully."); // }


                    _this16.getcategroryDetails();
                  } else {
                    if (data.statusCode == 100) {
                      _this16.alertService.error(data.reason);
                    } else {
                      _this16.alertService.error("Error occurred while deleting data. Please try again");
                    }
                  }
                });
              } else {}
          ...
          */
          ...
          value: function onChange(ev, type) {
            ...
            if (ev) {
              ...
              if (type == "plant") {// if (this.searchDet) {
                //   this.departmentList = [];
                ...
                // }
              } else if (type == "dept") {// this.resetFormField(this.stakeholderForm, 'lineId');
                // this.cellList = [];
                // this.searchDet.cellList = [];
                // this.searchDet.lineId = [];
              }
          ...
          value: function getDepartmentList(branch) {
            ...
            this.assessmentService.getDepartmentByBranch("getdepartmentlistbybranchid/" + branch).subscribe(function (res) {
              if (res.result) {
                console.log(res);

                if (res.deptList != null && res.deptList.length > 0) {
                  /* Use For Add Screen */
                  _this17.departmentList = _this17.setArray(res.deptList, "deptId", "deptName");
                  _this17.departmentList = _this17.sortFunction(_this17.departmentList, "deptName");
                  _this17.searchDet.dept = [_this17.departmentList[0]];
                  console.log(_this17.departmentList);
                } else {
                  _this17.searchDet.departmentList = [];
                }
              } else {
                _this17.searchDet.departmentList = [];
              }
            ...
            this.assessmentService.getCellList("apis/sm/getCellList", req).subscribe(function (response) {
              if (response.result) {
                if (response.dataList != null && response.dataList.length > 0) {
                  _this18.cellList = _this18.setArray(response.dataList, "lineId", "lineName");
                  _this18.cellList = _this18.sortFunction(_this18.cellList, "lineName");
                  _this18.searchDet.cell = [_this18.cellList[0]];
                } else {
                  _this18.cellList = [];
                }
              } else {
          ...
          value: function getWorkforceList(data) {
            ...
            this.assessmentService.getWorkforceDeploymentData("apis/sm/getWorkstationList", req).subscribe(function (res) {
              if (res.result) {
                console.log(res);

                if (res.dataList != null && res.dataList.length > 0) {
                  _this19.workforceList = _this19.setArray(res.dataList, "id", "workstation");
                  _this19.workforceList = _this19.sortFunction(_this19.workforceList, "workstation");
                  _this19.searchDet.workforceList = [_this19.workforceList[0]];
                  console.log(_this19.workforceList);
                } else {
                  _this19.workforceList = [];
                }
              } else {
                _this19.workforceList = [];
              }
          ...
          key: "validateTimeInput",
          value: function validateTimeInput(control) {
            var value = control.value;
      ...
      AssessmentDetailComponent.ctorParameters = function () {
        return [{
      ...
      AssessmentDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModalConfig"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], _assessment_service__WEBPACK_IMPORTED_MODULE_6__["AssessmentService"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"], src_app_theme_shared_components__WEBPACK_IMPORTED_MODULE_7__["AlertService"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__["Title"], Object])], AssessmentDetailComponent);
      /***/
    },
    ...
    function Agah(module, __webpack_exports__, __webpack_require__) {
      ...
      var _assessment_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./assessment.component */
      "F5dy");
      /* harmony import */
      ...
      var src_app_shared_pipe_custom_pipe_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/app/shared/pipe/custom-pipe.module */
      "QrAV");
      /* harmony import */


      var _assessment_detail_assessment_detail_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./assessment-detail/assessment-detail.module */
      "KXr7");
      /* harmony import */


      var _assessment_constant__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./assessment.constant */
      "ZQ3s");
      ...
      AssessmentModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_assessment_component__WEBPACK_IMPORTED_MODULE_4__["AssessmentComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _assessment_routing_module__WEBPACK_IMPORTED_MODULE_3__["AssessmentRoutingModule"], src_app_theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], src_app_theme_shared_components__WEBPACK_IMPORTED_MODULE_6__["TopBarModule"], src_app_theme_shared_components__WEBPACK_IMPORTED_MODULE_6__["LoginInfoModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_9__["NgMultiSelectDropDownModule"], src_app_shared_pipe_custom_pipe_module__WEBPACK_IMPORTED_MODULE_10__["CustomPipeModule"], _assessment_detail_assessment_detail_module__WEBPACK_IMPORTED_MODULE_11__["AssessmentDetailModule"]],
        providers: [{
          provide: 'Constant',
          useValue: _assessment_constant__WEBPACK_IMPORTED_MODULE_12__["CONSTANT"]
        }]
      })], AssessmentModule);
      /***/
    },
    ...
    /***/
    function BB5g(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AssessmentDetailRoutingModule", function () {
        return AssessmentDetailRoutingModule;
      });
      /* harmony import */
      ...
      var _assessment_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./assessment-detail.component */
      "AWsS");

      var routes = [{
        path: '',
        component: _assessment_detail_component__WEBPACK_IMPORTED_MODULE_3__["AssessmentDetailComponent"]
      }];

      var AssessmentDetailRoutingModule = function AssessmentDetailRoutingModule() {
        _classCallCheck(this, AssessmentDetailRoutingModule);
      };

      AssessmentDetailRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
    ...
    /***/
    function BQf9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function EoV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function F5dy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_assessment_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./assessment.component.html */
      "srSa");
      /* harmony import */


      var _assessment_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _assessment_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./assessment.service */
      "p3TK");
      /* harmony import */
      ...
      var AssessmentComponent = /*#__PURE__*/function () {
        function AssessmentComponent(router, apiService, modalConfig, modalService, fb, alertService, Constant) {
        ...
        _createClass(AssessmentComponent, [{
          ...
          */
          ...
          value: function getAccessiblePlantList() {
            ...
            this.apiService.getBranchAccessList("getBranchAccessSetupByEmpId/" + this.loggedInEmpDet.organization.orgId + "/" + this.loggedInEmpDet.empId).subscribe(function (res) {
              if (res.result) {
          ...
          */
          ...
          key: "goAssessmentDetailPage",
          value: function goAssessmentDetailPage(url, data, flag) {
            if (data == "") {
              data = {
                isEditable: true,
                assessmentId: 0,
          ...
          value: function getAssessmentList() {
            var _this22 = this;
            ...
            if (this.searchDet.workstationIds != null && this.searchDet.workstationIds.length > 0) {
            ...
            this.apiService.getAssessmentList("apis/sm/getAssessmentList", req).subscribe(function (response) {
              if (response.result) {
                // this.listLoading = false;
                if (_this22.staticPagination.page == 1) {
                  _this22.staticPagination.total = response.totalCount;
                  _this22.staticPagination.totalPages = Math.ceil(response.totalCount / _this22.staticPagination.itemsPerPage);
                }

                if (response.dataList != null && response.dataList.length > 0) {
                  _this22.assessementList = response.dataList;
                  console.log(_this22.assessementList);
                  _this22.staticPagination.listLength = _this22.assessementList.length;
                } else {
                  _this22.assessementList = [];
                  _this22.staticPagination.listLength = _this22.assessementList.length;
                }
              } else {
                _this22.assessementList = [];
          ...
          */
          ...
          key: "deleteAssessment",
          value: function deleteAssessment(x) {
            var _this23 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.fire({
              ...
              if (result.isConfirmed) {
                ...
                _this23.apiService.deleteAsssessment("apis/sm/deActiveAssessment", reqbody).subscribe(function (data) {
                  _this23.dataSpinner[x.assessmentId] = false;

                  if (data.result) {
                    _this23.alertService.success("Assessment removed successfully.");

                    _this23.getAssessmentList();
                  } else {
                    if (data.statusCode == 100) {
                      _this23.alertService.error(data.reason);
                    } else {
                      _this23.alertService.error("Error occurred while removing data. Please try again");
                    }
                  }
                });
              } else {
          ...
          */
          ...
          value: function removeFilter() {
            ...
            this.searchDet.lineId = []; // this.searchDet.branchId = [this.plantList[0]];
          ...
          */
          ...
          value: function onChange(ev, type) {
            ...
            if (ev) {
              ...
              if (type == "dept") {
                this.cellList = [];
                this.deptId = ev.id;
                this.searchDet.lineId = []; // this.resetFormField(this.filterData, "cell");
                // this.resetFormField(this.filterData, "workstation");

                this.getCellList(this.deptId); // this.resetFormField(this.filterData, 'lineId')
              }

              if (type == "plant") {
                console.log(ev);
                this.branchId = ev.id;
                this.searchDet.deptIds = []; // this.resetFormField(this.filterData, "deptIds");
                ...
                if (this.searchDet.addForm) {
                  console.log("inside"); // this.resetFormField(this.filterData, "deptId");
                }
              }
              ...
              if (type == "cell") {
                console.log(ev);
                this.lineId = ev.id;
                this.searchDet.workstationIds = []; // this.searchDet.work = [];
                // this.resetFormField(this.filterData, "workstation");
              ...
              if (type == "plant") {
                ...
                this.lineId = [];
                this.workforceList = []; // this.getWorkforceList(this.lineId);
              }
            }
          }
        }, {
          ...
          value: function onChangeAll(ev, type) {
            if (ev) {
              if (type == "cell") {
                this.lineId = ev.map(function (item) {
                  return item.id;
                });
                this.searchDet.workstationIds = [];
                this.getWorkforceList(this.lineId);
          ...
          */
          ...
          key: "uploadAssessmentDetails",
          value: function uploadAssessmentDetails(content) {
            var _this24 = this;
            ...
            this.apiService.uploadAssessmentData("apis/sm/uploadAssessments", formData).subscribe(function (data) {
              _this24.isUploadSpinner = false;
              console.log(data);

              if (data.result) {
                console.log(data);

                _this24.alertService.success("Assessment uploaded successfully.");

                if (_this24.filterFlag) {
                  _this24.getAssessmentList();
                } else {
                  _this24.getAssessmentList();
                }

                _this24.isUpload = false;
                _this24.fileSelected = false;
              } else {
                if (data.statusCode == 500) {
                  console.log("500");

                  _this24.alertService.error("Oops! Something went wrong");
                } else if (data.statusCode == 100) {
                  if (data.responseData) {
                    if (data.responseData.errorInSheet) {
                      if (data.responseData.errorList != null && data.responseData.errorList.length > 0) {
                        _this24.excelErrorList = data.responseData.errorList;

                        _this24.modalService.open(content, {
                    ...
                    if (data.responseData.reason) {
                      _this24.alertService.error(data.responseData.reason);
                    ...
                    _this24.alertService.error(data.reason);
                  }
                } else {
                  _this24.alertService.error("Error occurred while upload file. Please try again");
                }
              }
            });
          }
          ...
          value: function getDepartmentList(branch) {
            ...
            this.apiService.getDepartmentByBranch("getdepartmentlistbybranchid/" + branch).subscribe(function (res) {
              if (res.result) {
                ...
                if (res.deptList != null && res.deptList.length > 0) {
                  /* Use For Add Screen */
                  _this25.departmentList = _this25.setArray(res.deptList, "deptId", "deptName"); // this.departmentList = this.sortFunction(this.departmentList, "deptName");

                  _this25.searchDet.dept = [_this25.departmentList[0]];
                  console.log(_this25.departmentList);
                } else {
          ...
          value: function getCellList(data) {
            ...
            this.apiService.getCellList("apis/sm/getCellList", req).subscribe(function (response) {
              if (response.result) {
                if (response.dataList != null && response.dataList.length > 0) {
                  _this26.cellList = _this26.setArray(response.dataList, "lineId", "lineName"); // this.cellList = this.sortFunction( this.cellList,"lineName");

                  console.log(_this26.cellList); // this.searchDet.cell = [this.cellList[0]];

                  console.log(_this26.searchDet.cell);
                } else {
                  _this26.cellList = [];
                }
              } else {
          ...
          value: function getWorkforceList(data) {
            ...
            this.apiService.getWorkforceDeploymentData("apis/sm/getWorkstationList", req).subscribe(function (res) {
              if (res.result) {
                ...
                if (res.dataList != null && res.dataList.length > 0) {
                  _this27.workforceList = _this27.setArray(res.dataList, "id", "workstation"); // this.workforceList = this.sortFunction( this.workforceList,"workstation");

                  _this27.searchDet.workforceList = [_this27.workforceList[0]];
                  console.log(_this27.workforceList);
                } else {
                  _this27.workforceList = [];
                }
              } else {
                _this27.workforceList = [];
              }
      ...
      AssessmentComponent.ctorParameters = function () {
        return [{
      ...
      AssessmentComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _assessment_service__WEBPACK_IMPORTED_MODULE_5__["AssessmentService"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbModalConfig"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbModal"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], src_app_theme_shared_components__WEBPACK_IMPORTED_MODULE_9__["AlertService"], Object])], AssessmentComponent);
      /***/
    },
    ...
    /***/
    function KXr7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AssessmentDetailModule", function () {
        return AssessmentDetailModule;
      });
      /* harmony import */
      ...
      var _assessment_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./assessment-detail-routing.module */
      "BB5g");
      /* harmony import */


      var _assessment_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./assessment-detail.component */
      "AWsS");
      /* harmony import */
      ...
      var AssessmentDetailModule = function AssessmentDetailModule() {
        _classCallCheck(this, AssessmentDetailModule);
      };

      AssessmentDetailModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_assessment_detail_component__WEBPACK_IMPORTED_MODULE_4__["AssessmentDetailComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _assessment_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__["AssessmentDetailRoutingModule"], _theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_6__["NgMultiSelectDropDownModule"]],
        providers: [{
          provide: 'Constant',
    ...
    /***/
    function ZQ3s(module, __webpack_exports__, __webpack_require__) {
      "use strict";
